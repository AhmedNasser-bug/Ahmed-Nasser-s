...
## 2025-06-11 - Semantic Focus States\n**Learning:** Implementing explicit keyboard focus styles (`focus-visible:ring-2 focus-visible:outline-none`) instead of relying solely on standard outline overrides prevents unintended focus issues and ensures a cleaner visual state specifically for keyboard navigators, not mouse users.\n**Action:** Use `focus-visible` pseudo-class natively with Tailwind ring utilities to deliver equitable keyboard UI interactions.
