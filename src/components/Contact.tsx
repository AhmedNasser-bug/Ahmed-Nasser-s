        ...
        <div className="px-4 md:px-10 lg:px-40 flex flex-1 justify-center">
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1 gap-8">
            ...
            <GSAPTilt maxTilt={4} perspective={1200}>
              <div className="w-full h-full bg-surface border border-border-color shadow-hard p-8 hover:shadow-hard-hover transition-shadow duration-300" data-aos="fade-up">
            ...
            {/* Contact Section */}
            <GSAPTilt maxTilt={4} perspective={1200}>
              <div className="w-full h-full bg-surface border border-border-color shadow-hard p-8 hover:shadow-hard-hover transition-shadow duration-300" data-aos="fade-up" data-aos-delay="100">
