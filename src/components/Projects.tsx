                      ...
                      >
                        ...
                        <div className="p-6 flex flex-col flex-grow">
                          ...
                          <div className="mt-auto">
                            ...
                            {project.link ? (
                              <a href={project.link} target="_blank" rel="noreferrer" aria-label="View Live Deployment (opens in a new tab)" className="inline-flex items-center font-mono text-xs uppercase text-primary font-bold hover:underline group/link">
