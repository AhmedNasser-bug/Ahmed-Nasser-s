                      ...
                      >
                        ...
                        <div className="p-6 flex flex-col flex-grow">
                          <div className="flex justify-between items-start mb-2">
                            ...
                            {project.link && (
                              <a href={project.link} target="_blank" rel="noreferrer" className="text-muted hover:text-primary transition-colors p-1 focus-visible:outline-2 focus-visible:outline-primary focus-visible:-outline-offset-1" aria-label="External Link (opens in a new tab)" title="External Link (opens in a new tab)">
                          ...
                          <div className="mt-auto">
                            ...
                            {project.link ? (
                              <a href={project.link} target="_blank" rel="noreferrer" className="inline-flex items-center font-mono text-xs uppercase text-primary font-bold hover:underline group/link focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2" aria-label="View Live Deployment (opens in a new tab)" title="View Live Deployment (opens in a new tab)">
