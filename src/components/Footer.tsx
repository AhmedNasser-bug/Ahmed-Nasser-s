          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            {PROFILE.contact.linkedin && (
              <a 
                ...
                className="bg-text-main text-surface hover:bg-primary transition-colors border-2 border-text-main hover:border-primary px-8 py-3 font-mono font-bold uppercase tracking-wider flex items-center gap-2 shadow-hard hover:-translate-y-0.5 hover:-translate-x-0.5 focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2"
                aria-label="LinkedIn (opens in a new tab)"
                title="LinkedIn (opens in a new tab)"
              >
                LinkedIn 
                <svg className="w-4 h-4 ml-1 fill-current" viewBox="0 0 24 24" aria-hidden="true"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
              </a>
            )}
            <a 
              ...
              title="WhatsApp (opens in a new tab)"
            >
              WhatsApp
            ...
            <a 
              ...
              title="Upwork (opens in a new tab)"
            >
              Upwork
          ...
          <div className="bg-surface border border-border-color shadow-hard p-6 max-w-[500px] mx-auto text-left flex flex-col gap-4 relative">
            ...
            <div className="flex items-center gap-4 group">
              <div className="w-12 h-12 bg-primary/10 border border-primary flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:text-surface transition-colors">
                <Mail className="w-5 h-5 text-primary group-hover:text-surface" />
              </div>
              <div>
                <div className="text-xs text-muted font-mono uppercase tracking-wider">Email</div>
                <a href={`mailto:${PROFILE.contact.email}`} className="text-lg font-bold hover:text-primary transition-colors text-text-main focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2">{PROFILE.contact.email}</a>
              </div>
            </div>

            <div className="flex items-center gap-4 group">
              <div className="w-12 h-12 bg-primary/10 border border-primary flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:text-surface transition-colors">
                <Phone className="w-5 h-5 text-primary group-hover:text-surface" />
              </div>
              <div>
                <div className="text-xs text-muted font-mono uppercase tracking-wider">Phone</div>
                <a href={`tel:${PROFILE.contact.phone}`} className="text-lg font-bold hover:text-primary transition-colors text-text-main focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2">{PROFILE.contact.phone}</a>
              </div>
            </div>
          </div>
        </div>
