            ...
            <div className="border-t border-border-color/15 pt-3 flex justify-between items-center">
              {project.link ? (
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="inline-flex items-center justify-center bg-text-main text-surface px-3 py-1.5 border border-border-color font-mono text-[10px] uppercase tracking-wider hover:bg-primary transition-colors "
                >
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="border-t border-border-color/15 pt-3 flex justify-between items-center">
                    <a 
                      ...
                      target="_blank" 
                      rel="noreferrer" 
                      className="w-full inline-flex items-center justify-center bg-surface hover:bg-text-main text-text-main hover:text-surface px-3 py-2 border border-border-color font-mono text-[10px] uppercase tracking-wider transition-colors "
                    >
