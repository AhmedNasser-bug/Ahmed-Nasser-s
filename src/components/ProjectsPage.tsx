      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6" role="list">
        {GITHUB_PROJECTS.map((project, idx) => {
          ...
          return (
            <div 
              key={idx}
              className="border border-border-color bg-surface shadow-hard hover:shadow-hard-hover hover:-translate-x-1 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between overflow-hidden" role="listitem"
            >
              {/* Header Telemetry */}
