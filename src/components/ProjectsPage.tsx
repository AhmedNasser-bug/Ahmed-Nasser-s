            ...
            {project.link && !isLiveStar && (
              <div className="flex border border-surface/20 bg-surface/5 rounded-sm p-0.5 overflow-hidden">
                <button
                  ...
                  className={`px-2 py-0.5 font-mono text-[9px] uppercase tracking-wider rounded-sm transition-all flex items-center gap-1 cursor-pointer focus-visible:outline-2 focus-visible:outline-surface focus-visible:outline-offset-2 ${
