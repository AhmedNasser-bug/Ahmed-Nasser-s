  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md px-6 flex flex-col gap-6">
        ...
        <div className="h-12 flex items-center bg-[#E0E7FF]/40 border border-primary/20 px-4 py-2 font-mono text-[11px] text-text-main shadow-[2px_2px_0px_rgba(55,48,163,0.1)]">
          <span className="text-primary font-bold mr-2">&gt;</span>
          <span className="animate-pulse">{activeLog}</span>
        </div>

        {/* Neobrutalist Progress Bar */}
        <div className="relative h-6 w-full bg-surface border-2 border-border-color shadow-hard overflow-hidden" role="progressbar" aria-valuenow={progress} aria-valuemin={0} aria-valuemax={100}>
          <div 
