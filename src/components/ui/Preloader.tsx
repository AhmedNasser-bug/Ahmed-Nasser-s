  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md px-6 flex flex-col gap-6">
        ...
        <div
          className="h-12 flex items-center bg-[#E0E7FF]/40 border border-primary/20 px-4 py-2 font-mono text-[11px] text-text-main shadow-[2px_2px_0px_rgba(55,48,163,0.1)]"
          aria-live="polite"
          aria-atomic="true"
        >
