...
const ScrollToTop: React.FC = () => {
  ...
  return (
    <div className={`fixed bottom-8 right-8 z-50 transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`} aria-hidden={!isVisible}>
      <button
        type="button"
        onClick={scrollToTop}
