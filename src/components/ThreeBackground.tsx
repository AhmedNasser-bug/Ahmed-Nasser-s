...
const ThreeBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Only run on desktop/tablet views for performance hygiene, and if user doesn't prefer reduced motion
    if (!container || window.innerWidth < 768 || prefersReducedMotion) return;
