    ...
    <>
      ...
      <div className="offcanvas offcanvas-end" tabIndex={-1} id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        <div className="offcanvas-header border-bottom border-dark">
          ...
          <button type="button" className="btn-close focus-visible:ring-2 focus-visible:outline-none" data-bs-dismiss="offcanvas" aria-label="Close navigation menu" title="Close navigation menu"></button>
        </div>
