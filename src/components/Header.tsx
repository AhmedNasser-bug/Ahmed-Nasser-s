...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className="offcanvas offcanvas-end" tabIndex={-1} id="offcanvasNavbar" aria-label="Main Menu">
        <div className="offcanvas-header border-bottom border-dark">
          <h2 className="offcanvas-title h5 m-0" id="offcanvasNavbarLabel" aria-hidden="true">{navLabel}</h2>
