...
const App: React.FC = () => {
  ...
  return (
    <>
      <a
        href="#main-content"
        className="fixed z-[100] top-4 left-4 sr-only focus:not-sr-only focus:absolute bg-surface text-text-main p-2 border border-border-color shadow-hard focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2"
      >
