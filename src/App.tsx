...
const App: React.FC = () => {
  ...
  return (
    <>
      ...
      <a
        href="#main-content"
        className="absolute left-0 top-0 z-[100] -translate-y-full bg-text-main text-surface px-4 py-2 font-mono text-sm font-bold transition-transform focus-visible:translate-y-0 focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2"
      >
