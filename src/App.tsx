...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Initialize Lenis for premium smooth scrolling only if user prefers it
  ...
  return (
    <>
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 z-[9999] bg-text-main text-surface px-4 py-2 font-mono font-bold"
      >
