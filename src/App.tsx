...
const App: React.FC = () => {
  ...
  return (
    <>
      ...
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute z-[9999] bg-primary text-surface p-4 font-bold focus-visible:outline-2 focus-visible:outline-offset-2">Skip to content</a>
