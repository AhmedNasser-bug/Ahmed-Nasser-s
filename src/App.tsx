...
const App: React.FC = () => {
  ...
  return (
    <>
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-text-main focus:text-surface focus:font-mono focus:text-sm focus:uppercase focus:tracking-wider focus:outline-2 focus:outline-primary focus:outline-offset-2"
      >
        Skip to content
      </a>
