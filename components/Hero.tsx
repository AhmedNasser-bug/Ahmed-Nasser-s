  ...
  return (
    <div className="relative border border-border-color bg-surface shadow-hard hover:shadow-hard-hover transition-all duration-300 w-full overflow-hidden flex flex-col pointer-events-auto">
      <div className="relative w-full aspect-[16/10] bg-background-light overflow-hidden border-b border-border-color">
        ...
        <button
          onClick={handlePrev}
          className="absolute left-2 top-1/2 -translate-y-1/2 bg-surface hover:bg-text-main hover:text-surface border border-border-color p-2 transition-all z-20 cursor-pointer shadow-hard focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
        ...
        <button
          onClick={handleNext}
          className="absolute right-2 top-1/2 -translate-y-1/2 bg-surface hover:bg-text-main hover:text-surface border border-border-color p-2 transition-all z-20 cursor-pointer shadow-hard focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
        ...
        <div className="flex gap-2 mt-2 justify-end" role="tablist" aria-label="Project carousel slides">
          {CAROUSEL_ITEMS.map((_, idx) => (
            <button
              ...
              className={`w-3 h-3 border border-border-color transition-colors cursor-pointer focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none focus-visible:ring-offset-2 ${
