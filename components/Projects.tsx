          ...
          <div className="layout-content-container flex flex-col w-full max-w-[1200px] flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {FEATURED_PROJECTS.map((project, idx) => (
                <article 
                  key={idx}
                  className="bg-surface border border-border-color flex flex-col group hover:bg-background-light transition-all duration-300 shadow-hard hover:shadow-hard-hover hover:-translate-y-1 hover:-translate-x-1"
                  data-aos="fade-up"
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      {project.link && (
                        <a href={project.link} target="_blank" rel="noreferrer" className="text-muted hover:text-primary transition-colors p-1 focus-visible:ring-2 focus-visible:outline-none" aria-label="Open project in new tab" title="Open project in new tab">
                    ...
                    <div className="mt-auto">
                      ...
                      {project.link ? (
                        <a href={project.link} target="_blank" rel="noreferrer" aria-label="View Live Deployment (opens in a new tab)" title="View Live Deployment (opens in a new tab)" className="inline-flex items-center font-mono text-xs uppercase text-primary font-bold hover:underline group/link focus-visible:ring-2 focus-visible:outline-none">
